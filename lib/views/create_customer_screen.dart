                        ...
                        Column(
                          ...
                          children: [
                            ...
                            MyTextField(
                              ...
                              onChanged: (value) {
                                if (value.isNotEmpty) {
                                  String newValue = value[0].toUpperCase() +
                                      value.substring(1);
                                  if (newValue != value) {
                                    customerProvider.customerName.value =
                                        customerProvider.customerName.value
                                            .copyWith(
                                      text: newValue,
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: MyDropdownMenu<StateObj>(
                                            ...
                                            dropdownMenuEntries: listConstant
                                                .statesOfIndia
                                                .map((state) {
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      icon: const Icon(Icons.delete,
                                          color: Colors.red),
                                      onPressed: () {
                                        if (customerProvider.addresses.length ==
                                            1) {
                                          Toasts.showToastBar(
                                              context: context,
                                              text:
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: MyDropdownMenu<StateObj>(
                                            ...
                                            hintText:
                                                "Enter State", // 👈 Placeholder text here
                                            onSelected:
                                                (StateObj? selectedState) {
                                              entry.selectedState =
                                                  selectedState;
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                Color(0xffEEEFF2), // button background color
                        ...
                        Buttons.loginButton(
                          ...
                          onPressed: () {
                            ...
                            if (customerProvider.customerMobile.text.length !=
                                10) {
                              customerProvider.loadingButtonController.reset();
                              Toasts.showToastBar(
                                context: context,
                            ...
                            for (int i = 0;
                                i < customerProvider.addresses.length;
                                i++) {
                              ...
                              if (address.cityController.text.isEmpty) {
                                Toasts.showToastBar(
                                  context: context,
                                  text:
                                      "Please enter customer address city (Address ${i + 1})",
                                  color: Colors.red,
                                );
                                customerProvider.loadingButtonController
                                    .reset();
                                return;
                              }
                              if (address.stateController.text.isEmpty) {
                                Toasts.showToastBar(
                                  context: context,
                                  text:
                                      "Please enter customer address state (Address ${i + 1})",
                                  color: Colors.red,
                                );
                                customerProvider.loadingButtonController
                                    .reset();
                              ...
                              if (address.pinController.text.isEmpty) {
                                Toasts.showToastBar(
                                  context: context,
                                  text:
                                      "Please enter customer address pincode (Address ${i + 1})",
                                  color: Colors.red,
                                );
                                customerProvider.loadingButtonController
                                    .reset();
                              ...
                              if (address.pinController.text.length != 6) {
                                Toasts.showToastBar(
                                  context: context,
                                  text:
                                      "Pincode must be 6 characters. (Address ${i + 1})",
                                  color: Colors.red,
                                );
                                customerProvider.loadingButtonController
                                    .reset();
                            ...
                            for (int i = 0;
                                i < customerProvider.deliveryAddresses.length;
                                i++) {
                              final delivery =
                                  customerProvider.deliveryAddresses[i];
                              if (delivery.cityController.text.isEmpty) {
                                Toasts.showToastBar(
                                  context: context,
                                  text:
                                      "Please enter delivery address city (Delivery ${i + 1})",
                                  color: Colors.red,
                                );
                                customerProvider.loadingButtonController
                                    .reset();
                              ...
                              if (delivery.stateController.text.isEmpty) {
                                Toasts.showToastBar(
                                  context: context,
                                  text:
                                      "Please enter delivery address state (Delivery ${i + 1})",
                                  color: Colors.red,
                                );
                                customerProvider.loadingButtonController
                                    .reset();
                              ...
                              if (delivery.pinController.text.isEmpty) {
                                Toasts.showToastBar(
                                  context: context,
                                  text:
                                      "Please enter delivery address pincode (Delivery ${i + 1})",
                                  color: Colors.red,
                                );
                                customerProvider.loadingButtonController
                                    .reset();
                              ...
                              if (delivery.pinController.text.length != 6) {
                                Toasts.showToastBar(
                                  context: context,
                                  text:
                                      "Pincode must be 6 characters. (Delivery ${i + 1})",
                                  color: Colors.red,
                                );
                                customerProvider.loadingButtonController
                                    .reset();
                            ...
                            customerProvider.addCustomer(
                              ...
                              gstLocation:
                                  customerProvider.customerGSTLocation.text,
                            );
                          },
