                    ...
                    children: [
                      ...
                      pw.Text(
                        'Qty : ${billingItems.fold<double>(0.0, (total, item) {
                          // quantity-யை safe-ஆ handle பண்ணு
                      ...
                      // )
                      pw.Text(
                        'Grand Total : ₹${double.tryParse(data.oTotal?.toString() ?? '')?.toStringAsFixed(1) ?? '0.0'}',
                        style: simpleText,
                        textAlign: pw.TextAlign.right,
                      )
                    ],
